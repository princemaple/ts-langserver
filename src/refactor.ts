...
export function asSelectRefactoring(
  info: tsp.ApplicableRefactorInfo,
  args: tsp.FileRangeRequestArgs,
): lsp.CodeAction {
...
export function asApplyRefactoring(
  ...
  return lsp.CodeAction.create(
    action.description,
    lsp.Command.create(action.description, Commands.APPLY_REFACTORING, <
